(defproject fulcro-todomvc "1.0.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.9.0-alpha17"]
                 [org.clojure/clojurescript "1.9.671" :scope "aot"]
                 ...
                 [datomic-schema "1.3.0"] ; schema helpers
                 [io.rkn/conformity "0.5.1"] ; migration tool
                 [commons-codec "1.10"]
  ...
  :clean-targets ^{:protect false} ["resources/public/js/test"
                                    "resources/public/js/production"
                                    "resources/public/js/fulcro-todomvc.min.js"
                                    "resources/public/js/compiled" "target" "i18n/out"]
